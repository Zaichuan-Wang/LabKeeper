...
def seed_storage(conn: sqlite3.Connection, now: str) -> dict[int, tuple[int, int]]:
    storage_nodes = [
        (1, None, "研究所", "LAB", 2, 3, None, None, "Demo 根空间", 0),
        (2, 1, "负80冰箱A", "FZ-A", 3, 3, 1, 1, "抗体、细胞因子和常用标本", 10),
        (3, 2, "A-第一层抽屉", "FZ-A-D1", 2, 3, 1, 1, "高频使用格架", 10),
        (4, 3, "抗体格架-001", "AB-001", 9, 9, 1, 1, "流式抗体", 10),
        (5, 3, "样本格架-001", "SMP-001", 9, 9, 1, 2, "血清、血浆和灌洗液", 20),
        (6, 3, "细胞因子格架-001", "CYT-001", 9, 9, 1, 3, "重组因子和刺激物", 30),
        (7, 2, "A-第二层抽屉", "FZ-A-D2", 2, 3, 1, 2, "低频样本", 20),
        (8, 7, "样本格架-002", "SMP-002", 9, 9, 1, 1, "全血和细胞悬液", 10),
        (9, 7, "组织格架-001", "TIS-001", 9, 9, 1, 2, "组织和匀浆", 20),
        (10, 1, "负80冰箱B", "FZ-B", 3, 3, 1, 2, "备用与长期冻存", 20),
        (11, 10, "B-第一层抽屉", "FZ-B-D1", 2, 3, 1, 1, "备用样本格架", 10),
        (12, 11, "备用样本格架-003", "SMP-003", 9, 9, 1, 1, "项目备份样本", 10),
        (13, 1, "4度冰箱", "FRIDGE-4C", 2, 3, 2, 1, "短期试剂和缓冲液", 30),
        (14, 13, "4度门架", "4C-RACK", 2, 4, 1, 1, "常用缓冲液", 10),
        (15, 14, "酶和缓冲液格架-001", "ENZ-001", 5, 5, 1, 1, "酶、抑制剂、缓冲液", 10),
        (16, 14, "短期试剂格架-001", "TMP-001", 5, 5, 1, 2, "短效期试剂", 20),
        (17, 1, "常温试剂柜", "CAB-RT", 3, 4, 2, 2, "耗材和常温试剂", 40),
        (18, 17, "柜1层", "CAB-RT-S1", 2, 5, 1, 1, "耗材和试剂", 10),
        (19, 18, "耗材格架-001", "CONS-001", 4, 6, 1, 1, "管、板、滤网", 10),
        (20, 18, "ELISA试剂区", "KIT-001", 4, 6, 1, 2, "ELISA 和分子试剂", 20),
        (21, 1, "液氮罐", "LN2", 2, 2, 2, 3, "细胞冻存", 50),
        (22, 21, "细胞冻存架A", "LN2-RACK-A", 10, 10, 1, 1, "冻存细胞", 10),
        (23, 1, "待处理临时区", "STAGING", 1, 4, 1, 3, "新到货和待归位", 60),
        (24, 23, "临时周转格架", "STG-001", 4, 6, 1, 1, "短期周转", 10),
        (25, 11, "抗体格架-002", "AB-002", 9, 9, 1, 2, "循环生成抗体", 20),
        (26, 11, "细胞因子格架-002", "CYT-002", 9, 9, 1, 3, "循环生成细胞因子", 30),
        (27, 11, "试剂格架-002", "KIT-002", 9, 9, 2, 1, "循环生成试剂", 40),
        (28, 14, "缓冲液格架-002", "BUF-002", 5, 8, 1, 3, "循环生成缓冲液和酶", 30),
        (29, 14, "培养基格架-002", "MED-002", 5, 8, 1, 4, "循环生成培养基和染料", 40),
        (30, 18, "耗材格架-002", "CONS-002", 4, 8, 1, 3, "循环生成耗材", 30),
        (31, 11, "样本格架-004", "SMP-004", 9, 9, 2, 2, "循环生成标本", 50),
        (32, 11, "样本格架-005", "SMP-005", 9, 9, 2, 3, "循环生成标本", 60),
        (33, 7, "样本格架-006", "SMP-006", 9, 9, 1, 3, "循环生成标本", 30),
    ]
    conn.executemany(
        """
    ...
    return {int(node[0]): (int(node[4] or 1), int(node[5] or 1)) for node in storage_nodes}
